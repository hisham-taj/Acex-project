...
const AssignmentHelpPage = () => {
  return (
    <div className="min-h-auto bg-[#D6DDFF] p-6 ">
      {/* Header */}
      <header className="text-center py-8 bg-gradient-to-r from-[#C2CBFD] to-[#EEE7F6] text-blue-900 shadow-md">
      ...
      <div className="container mx-auto mt-10 flex max-md:flex-col">
        {/* Sidebar */}
        <aside className="w-1/4 bg-[#EEE7F6] p-6 rounded-lg shadow-lg border border-gray-200 max-md:w-full">
        ...
        <main className="w-3/4 bg-[#EEE7F6] p-8 ml-6 rounded-lg shadow-lg border border-gray-200 max-md:w-full max-md:ml-0">
