...
const SalientFeatures = () => {
  return (
    <div className="bg-[#7191E6] text-white p-8 rounded-lg shadow-lg max-w-5xl mx-auto mt-12">
      ...
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <button className="mt-6 bg-yellow-400 text-blue-800 px-6 py-3 rounded-md font-semibold hover:bg-yellow-600 transition-all">Review Us</button>
      </div>
