...
const FaqPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-10 bg-white text-black mt-10">
      ...
      {/* Contact Section */}
      <div className="mt-12 text-center p-6 rounded-lg shadow-lg bg-black text-white">
        <h3 className="text-2xl font-bold mb-4">Still Have Questions?</h3>
        <p className="mb-6">Feel free to reach out to us for more information or support.</p>
        <a
          href="#"
          className="inline-block bg-white text-black font-semibold py-3 px-6 rounded-lg shadow-md hover:bg-gray-200 transition-all"
        >
          Contact Us
        </a>
      </div>
